...
!(function (b) {
    ...
    (ax.prototype = {
        ...
        open: function (t) {
            ...
            if (t.isObj === !1) {
                ...
                for (s = 0; s < p.length; s++) {
                    if (
                        ((q = p[s]), q.parsed && (q = q.el[0]), q === t.el[0])
                    ) {
                        aP.index = s;
                        break;
                    }
        ...
        _close: function () {
            ...
            aN.off("keyup" + aB + " focusin" + aB),
                ...
                !aP.st.showCloseBtn ||
                    (aP.st.closeBtnInside &&
                        aP.currTemplate[aP.currItem.type] !== !0) ||
                    (aP.currTemplate.closeBtn &&
                        aP.currTemplate.closeBtn.detach()),
                aP.st.autoFocusLast &&
                    aP._lastFocusedEl &&
        ...
        updateItemHTML: function () {
            ...
            if (
                ...
                ar("FirstMarkupParse", b),
                    b
                        ? (aP.currTemplate[e] = aQ(b))
                        : (aP.currTemplate[e] = !0);
            }
            aM &&
                aM !== h.type &&
                aP.container.removeClass("mfp-" + aM + "-holder");
            ...
            (aP.content = b),
                b
                    ? aP.st.showCloseBtn &&
                      aP.st.closeBtnInside &&
                      aP.currTemplate[d] === !0
                        ? aP.content.find(".mfp-close").length ||
                          aP.content.append(aq())
                        : (aP.content = b)
                    : (aP.content = ""),
                ar(aG),
        ...
        _openClick: function (j, i, h) {
            var b =
                void 0 !== h.midClick
                    ? h.midClick
                    : aQ.magnificPopup.defaults.midClick;
            if (
                b ||
                !(
                    2 === j.which ||
                ...
                j.type &&
                    (j.preventDefault(), aP.isOpen && j.stopPropagation()),
                    (h.el = aQ(j.mfpEl)),
        ...
        _setFocus: function () {
            (aP.st.focus
                ? aP.content.find(aP.st.focus).eq(0)
                : aP.wrap
            ).focus();
        },
        ...
        (aQ.magnificPopup = {
            ...
            close: function () {
                return (
                    aQ.magnificPopup.instance &&
                    aQ.magnificPopup.instance.close()
                );
            },
            ...
            if ("string" == typeof j) {
                if ("open" === j) {
                    ...
                    b.items
                        ? (h = b.items[a])
                        : ((h = i),
                          b.delegate && (h = h.find(b.delegate)),
                          (h = h.eq(a))),
            ...
            getInline: function (j, i) {
                if ((aj(), j.src)) {
                    ...
                    if (b.length) {
                        ...
                        aP.updateStatus("error", h.tNotFound),
                            (b = aQ("<div>"));
                    }
    ...
    aQ.magnificPopup.registerModule(ah, {
        ...
        proto: {
            ...
            getAjax: function (b) {
                ai && aQ(document.body).addClass(ai),
        ...
        proto: {
            ...
            getImage: function (p, o) {
                ...
                return (
                    aP._parseMarkup(
                        o,
                        { title: ad(p), img_replaceWith: p.img },
                        p
                    ),
                    aP.resizeImage(),
                    p.hasSize
                ...
                return (
                    ...
                    b && b.enabled
                        ? ((aL += " mfp-gallery"),
                          ...
                          au(aD + a, function () {
                              aP._preloadTimeout &&
                                  clearTimeout(aP._preloadTimeout),
                                  (aP._preloadTimeout = setTimeout(function () {
                                      aP.preloadNearbyImages(),
                                          (aP._preloadTimeout = null);
                                  }, 16));
                          }),
            ...
            _preloadItem: function (b) {
                if (((b = X(b)), !aP.items[b].preloaded)) {
                    ...
                    a.parsed || (a = aP.parseEl(b)),
                        ar("LazyLoad", a),
                        "image" === a.type &&
                            (a.img = aQ('<img className="mfp-img" />')
